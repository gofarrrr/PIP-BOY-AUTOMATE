...
interface ReadinessReportGeneratorProps {
    isComplete: boolean;
    onGenerate: () => void;
    pathSummary: PathSummary;
}

const ReadinessReportGenerator: React.FC<ReadinessReportGeneratorProps> = ({
    isComplete,
    onGenerate,
    pathSummary,
}) => {
    ...
    return (
        <div className="fixed bottom-24 left-1/2 transform -translate-x-1/2 z-50 animate-pulse">
            <button
                onClick={onGenerate}
            ...
            >
                ...
                <span className="flex flex-col items-start">
                    ...
                    <span className="text-sm opacity-80">Generate My Readiness Report</span>
                </span>
                <span className="text-2xl">→</span>
            </button>
        </div>
